...
int leftspeed=40;
int rightspeed=40;
int delta=-11; // positive if right is faster .. -65 for bot1 and -5 for bot2
...
void take_turn(int d)
{
	...
	while(1)
	{
		...
		if(d==1) velocity(leftspeed*0.5,(rightspeed-delta)*0.9);
		else if(d==2) velocity(leftspeed*0.9,(rightspeed-delta)*0.5);
